...
const renderColumn = ({ title, strings, isBenef }: Props) => (
  <div className="flex flex-col items-center pt-4">
    <div className="text-left container-items-pros">
      <p className="font-bold text-white text-2xl mb-2 text-center md:text-left lg:text-left">{title}</p>
...
const ProsComponent = () => {
  ...
  return (
    <div className="bg-pros p-8 mt-8 w-full" style={{ padding: '3vw', borderRadius:'25px' }}>
