...
const BentoComponentIndex = () => {
  ...
  return (
    <div
      ref={scope}
      className="grid h-100 w-100 grid-cols-4 xl:gap-10 gap-6 xl:py-10 py-6 xl:px-1 auto-rows-[76px]"
      style={{padding: '3vw'}}
    >
...
export default BentoComponentIndex;
