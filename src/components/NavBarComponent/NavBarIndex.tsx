            ...
            <div className="flex items-center">
              <div className="bg-red-600 rounded-full p-2 mr-2">
                <svg className="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 3a9 9 0 00-9 9c0 4.97 4.03 9 9 9s9-4.03 9-9a9 9 0 00-9-9zm-2 12a5 5 0 00-4.8 3.45 3.5 3.5 0 01-2.73-2.73A5 5 0 0014 10v2.8a3.5 3.5 0 012.73 2.73A5 5 0 0019 15zm-9-4a3 3 0 110-6 3 3 0 010 6z" />
                </svg>
              </div>
              <div>
          ...
          <a href="#" className="block p-4 rounded-lg hover:navbar-bg dark:hover:bg-gray-700">
            <div className="flex items-center">
              <div className="bg-red-500 rounded-full p-2 mr-2">
                <svg className="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14a2 2 0 11-4 0 2 2 0 014 0zM6 14a2 2 0 100-4 2 2 0 000 4z" />
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 6h8v12H8z" />
                </svg>
              </div>
              <div>
