  ...
  const MockupsData: MockupComponentProps[] = [
    {
      ...
      components: [
        ...
        },
        {
          ...
          content: (
            <>
              <p className="font-bold text-xl text-white-body">
      ...
      components: [
        {
          ...
          content: (
            <span className="font-semibold text-white-body">
              Con nuestro Multiagente no pierdas en tu flujo de atención ningún
              cliente <br />
              Todo tu servicio de atención al cliente a través de un único
          ...
          content: (
            <ul className="mockup-ul">
              ...
              <li className="flex flex-row items-center pb-2 text-white-body">
                ...
                <p>
                  Conectalo con CROMO, nuestro Software CRM, para mayor gestión
                </p>
              </li>
              <li className="flex flex-row items-center pb-2 text-white-body">
                <FaAngleRight />
              ...
              <li className="flex flex-row items-center pb-2 text-white-body">
                ...
                <p>
                  Implementaciones con Mercado Libre, Instagram, Facebook,
                  WhatsApp, etc
                </p>
              </li>
            </ul>
      ...
      components: [
        {
          ...
          content: (
            <span className="font-semibold text-white-body">
              Mejora tu reputación respondiendo en segundos con la ayuda de la
              IA, guarda respuestas predeterminada por usuario y lo más
              importante, responde desde cualquier lado y no pierdas ni una
              venta
            </span>
          ),
        },
          ...
          content: (
            <ul className="mockup-ul text-white-body">
              ...
              <li className="flex flex-row items-center pb-4">
                ...
                />
                <p>
                  Sabrás si un mensaje ya fue respondido y quién lo contestó
                </p>
              </li>
              <li className="flex flex-row items-center pb-4">
                <Image
                ...
                />
                <p>
                  Inteligencia artificial para asistir al seller con la
                  respuesta
                </p>
              </li>
            </ul>
      ...
      components: [
        {
          ...
          content: (
            <span className="font-semibold text-white-body">
              Realizá las tareas de seguimiento y gestión de tus clientes con
              nuestro CRM
            </span>
          ),
        },
          ...
          content: (
            <ul className="mockup-ul text-white-body">
              ...
              <li className="flex flex-row items-center pb-2">
                ...
                <p>
                  Determina estado de la conexión y lleva registro de tus
                  gestiones
                </p>
              </li>
              <li className="flex flex-row items-center pb-2">
                ...
                <p>
                  Mantené una conexión eficaz con tus clientes teniendo toda la
                  informacion a mano
                </p>
              </li>
              <li className="flex flex-row items-center pb-2">
                ...
                <p>
                  Estadísticas, filtros, búsquedas entre tus Seguimientos y
                  Clientes
                </p>
              </li>
              <li className="flex flex-row items-center pb-2">
                ...
                <p>
                  Llevá tu agenda totalmente integrada a recordatorios y envios
                  masivos para organizarte
                </p>
              </li>
            </ul>
          ),
      ...
      {MockupsData.map((mockup, index) => (
        <React.Fragment key={index}>
          <MockupComponent
            ...
            imageSrc={
              mockup.imageSrc === "video-meli"
                ? "/static/videos/videoMeLi.mp4"
                : mockup.imageSrc
            }
