...
const MockupComponent: React.FC<MockupComponentProps> = ({
  ...
  const renderTextFirst = () => {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
        <div
          className="flex flex-col text-white-body"
          style={{ padding: ".5rem" }}
        >
          <p className="text-xl font-semi-bold text-sky ">{copete}</p>
          <p className="text-4xl font-bold mb-4 text-white-body mockup-title-responsive">
            {aplyBR(title)}
          </p>
          {renderComponents()}
        </div>
        <div
          ...
          style={{ width: windowWidth < 700 ? "" : "100%" }}
        >
          {type === "png" ? (
            <Image
              src={imageSrc}
          ...
          <BtnCallToAction
            ...
            style={{
              width:
                (title.toUpperCase() === "¿POR QUÉ UN CHATBOT?" ||
                  title.toUpperCase() ===
                    "MANEJÁ MERCADO LIBRE DESDE TU WHATSAPP") &&
                windowWidth < 700
                  ? "100% "
                  : "100%",
            }}
          ...
          {type === "png" ? (
            ...
            <>
              <div
                ...
                className="flex justify-center items-center h-full"
                style={{
                  width: windowWidth < 700 ? "90vw" : "100%",
                  borderRadius: "25px",
                  overflow: "hidden",
                }}
              >
  ...
  return (
    <div
      ...
      style={{ padding: "2vw", boxShadow: boxShadowStyle, marginBottom: "4vh" }}
    >
