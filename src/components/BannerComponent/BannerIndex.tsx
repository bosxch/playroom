...
<div className="flex flex-col sm:flex-row h-100 w-100 justify-center banner-container bg-transparent">
        ...
        <div className="w-full p-4 sm:p-8 flex flex-col items-center justify-center text-center text-container-banner">
          ...
          <h1 className="text-white text-4xl sm:text-6xl lg:text-8xl font-bold mb-8 font-poppins text-center sm:text-center w-full">
            Subí de nivel <span className="gradient-text">tu empresa</span><br />de la mano de la <span className="gradient-text">IA</span>
          </h1>
          ...
          <div className='flex flex-col sm:flex-row justify-center items-center w-full p-4 sm:space-x-8 absolute bottom-0 items-banner mr-8'>
            <div className='flex flex-row items-center text-white pb-8' style={{marginLeft: 0}}>
              <Image src={checkImg} alt='check' height={30} width={30} className='mr-2' />
