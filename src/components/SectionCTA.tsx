...
const SectionCTA = () => {
    return (
        ...
        <p className="font-bold text-4xl text-white">Entonces <span className="gradient-text">empezá hoy</span> mismo <span className="gradient-text">tu experiencia</span> en Aoki <span className="gradient-text">GRATIS</span></p>
